...
@section('content')
    <div class="row details">
        <div class="col-lg-8 col-lg-offset-2 col-md-8 col-md-offset-2 col-xs-12">
            ...
            {!! Form::model($commsexec, ['route' => ['commsexecs.update', $commsexec->id], 'method' => 'PUT', 'data-parsley-validate' => '']) !!}

                <div class="form-group md-form">
                    {{ Form::label('fullname', 'Full Name') }}
                    {{ Form::text('fullname', null, ['class' => 'inputtext form-control', 'required' => '']) }}
                </div>

                <div class="form-group">
                    {{ Form::label('productcategories_id', 'Product Category') }}
                    {{ Form::select('productcategories_id', $categories, null, array('class' => '')) }}
                </div>

                {{ Form::submit('Update CommsExec', ['class' => 'inputbutton btn btn-primary']) }}
